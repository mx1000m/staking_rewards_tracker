...
exports.breakpointsStyles = exports.breakpointsStylesLegacy = exports.defaultBreakpointSizes = void 0;
...
const breakpointsStylesLegacy = (breakpointSizes) => {
    breakpointSizes = { ...exports.defaultBreakpointSizes, ...breakpointSizes };
    return /* css */ `
/* Base */
...
exports.breakpointsStylesLegacy = breakpointsStylesLegacy;
        ...
        if (!isBrowser) {
            ...
            const cssContent = typeof escapedCSS === 'function'
                ...
                : Array.isArray(escapedCSS)
                    ? escapedCSS.join('\n')
                    : escapedCSS;
            return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("style", { [framerCSSMarker]: true, "data-framer-component": id, dangerouslySetInnerHTML: { __html: cssContent } }), (0, jsx_runtime_1.jsx)(Component, { ...props })] }));
        }
