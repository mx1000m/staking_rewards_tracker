...
exports.generateStackblitzFiles = generateStackblitzFiles;
const string_dedent_1 = __importDefault(require("string-dedent"));
function generateStackblitzFiles({ projectId, appComponentCode = '', title = '', }) {
    const packageJson = {
    ...
    const viteConfig = (0, string_dedent_1.default) `
    ...
    `;
    const postcssConfig = (0, string_dedent_1.default) `
    ...
    `;
    const tailwindConfig = (0, string_dedent_1.default) `
    ...
    `;
    const indexHtml = (0, string_dedent_1.default) `
    ...
    const app = appComponentCode ||
        ...
        `;
    const main = (0, string_dedent_1.default) `
    ...
    `;
    const css = (0, string_dedent_1.default) `
        @tailwind base;
        @tailwind components;
        @tailwind utilities;
    `;
    return [
        ...
        },
        {
            ...
            contents: (0, string_dedent_1.default) `
