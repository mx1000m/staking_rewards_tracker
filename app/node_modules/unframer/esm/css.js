        ...
        if (!isBrowser) {
            ...
            const cssContent = typeof escapedCSS === 'function'
                ...
                : Array.isArray(escapedCSS)
                    ? escapedCSS.join('\n')
                    : escapedCSS;
            return (_jsxs(_Fragment, { children: [_jsx("style", { [framerCSSMarker]: true, "data-framer-component": id, dangerouslySetInnerHTML: { __html: cssContent } }), _jsx(Component, { ...props })] }));
        }
