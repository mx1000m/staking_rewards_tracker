...
export const Dashboard: React.FC<DashboardProps> = ({ onAddTracker }) => {
  ...
  return (
    <div style={{ width: "100%", minWidth: "1000px" }}>
      ...
      <div style={{ background: "#181818", border: "1px solid #2b2b2b", borderRadius: "14px", padding: "24px", marginBottom: "24px", minWidth: "1000px" }}>
      ...
      <div style={{ background: "#181818", border: "1px solid #2b2b2b", borderRadius: "14px", marginBottom: "24px", minWidth: "1000px" }}>
